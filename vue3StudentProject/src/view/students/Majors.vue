<template>
  ...
  <el-dialog v-model="majorFormVisible" title="添加专业" width="500">
    <el-form :model="major" :rules="rules" ref="majorFormRef" label-width="90px">
    ...
    <template #footer>
      <div class="dialog-footer">
        <el-button
          @click="major._id == null ? addData(majorFormRef) : updateData(majorFormRef)"
          >确定</el-button
        >
...
const getMajorList = () => {
  majorStore.getMajorList({ page: currentPage.value, size: pageSize.value }).then((res) => {
